...
console.log('BZEdge Service native interface vs. BZEdge JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.bzedge',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('BZEdge started');
});

bitcoind.on('ready', function() {

  console.log('BZEdge ready');
