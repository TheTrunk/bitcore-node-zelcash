...
var BASE_PACKAGE = {
  description: 'A full ZelCash node build with Bitcore',
  repository: 'https://github.com/TheTrunk/bitcore-node-zelcash#safecoin',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zelcash': 'TheTrunk/bitcore-lib-zelcash#safecoin',
    'bitcore-node-zelcash': 'TheTrunk/bitcore-node-zelcash#safecoin'
  }
};
