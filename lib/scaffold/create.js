...
var BASE_PACKAGE = {
  ...
  repository: 'https://github.com/TheTrunk/bitcore-node-zelcash#anon',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zelcash': 'TheTrunk/bitcore-lib-zelcash#anon',
    'bitcore-node-zelcash': 'TheTrunk/bitcore-node-zelcash#anon'
  }
};
