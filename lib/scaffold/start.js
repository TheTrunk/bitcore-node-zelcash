...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for commerciumd is necessary for this upgrade with the "reindex=1" commercium.conf option. \n' +
                 'There are changes necessary in both commercium.conf and bitcore-node.json. \n\n' +
